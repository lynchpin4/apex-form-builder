(function() {
  ...
  module.exports = Forms.PopupScriptEditor = (function(superClass) {
    ...
    PopupScriptEditor.title = "Script Editor";
        ...
        return function() {
          ...
          return _this.div({
            ...
            return _this.div({
              ...
              _this.subview("spinner2", new Apex.widgetResolver.widgets["spinner"]({
                "widgetType": "spinner",
                "x": 53,
                "y": 79,
                "w": 10,
              ...
              _this.subview("editor3", new Apex.widgetResolver.widgets["editor"]({
                "widgetType": "editor",
                "x": 7,
                "y": 24,
                "w": 400,
              ...
              _this.subview("button4", new Apex.widgetResolver.widgets["button"]({
                "widgetType": "button",
                "x": 353,
                "y": 228,
                "w": 56,
              ...
              return _this.subview("button5", new Apex.widgetResolver.widgets["button"]({
                "widgetType": "button",
                "x": 285,
                "y": 228,
                "w": 60,
