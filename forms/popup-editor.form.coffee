    ...
    @tag 'atom-panel', class: 'form-widget apex-form-widget modal form-widget-floating form-PopupScriptEditor', =>
      ...
      @div class: 'inset-panel', =>
        ...
        @div class: 'panel-body padded', outlet: 'contents', =>
          ...
          @subview "editor2", new Apex.widgetResolver.widgets["editor"]({"widgetType":"editor","x":7,"y":24,"w":400,"h":194}).get()
          @subview "button3", new Apex.widgetResolver.widgets["button"]({"widgetType":"button","x":353,"y":228,"w":56,"h":29,"title":"Save"}).get()
          @subview "button4", new Apex.widgetResolver.widgets["button"]({"widgetType":"button","x":285,"y":228,"w":60,"h":29,"title":"Cancel"}).get()
