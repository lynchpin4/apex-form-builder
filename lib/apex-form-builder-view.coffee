...
class Apex.Form.BuilderView extends View
  ...
  @content: ->
    @div class:'apex-form-pane', =>
      @div class:'apex-form-toolbox', outlet: 'toolboxContainer', =>
        @subview 'toolbox', new Apex.Form.ToolboxView()
        @subview 'formProperties', new Apex.Form.PropertiesView()
  ...
  initActions: ->
    ...
    # add interact resize to the new widget
    @interact = Apex.interact
    console.log 'added interact handlers'
